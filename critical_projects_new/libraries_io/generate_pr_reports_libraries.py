...
def main():
    ...
    for pkg_manager in PKG_MANAGERS_LIST:
        ...
        path_to_source_file = os.path.join(args.input_directory, pkg_manager, f"lib_nodes_{pkg_manager}.csv")
        path_to_dest_file = os.path.join(args.output_directory, "libraries_io", f"{pkg_manager.lower()}_top_{NUMBER_OF_PROJECTS}.csv")
